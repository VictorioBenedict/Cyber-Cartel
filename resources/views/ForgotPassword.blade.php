...
<body>
    ...
    <header class="py-5">
        <div class="container">
            ...
            <p>Enter your Email Address to reset your accounts password.</p>
        </div>
    </header>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-6 col-md-8 col-sm-10">
                    <form id="loginForm" action="/conPass" method="post" style="border: 1px solid #ccc; border-radius: 10px; padding: 20px;">
                        @csrf

                        <div class="form-group" style="margin-bottom: 15px;">
                            <label for="resEmail">Enter your Email Address</label>
