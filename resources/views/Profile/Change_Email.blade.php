                ...
                <tr>
                    ...
                    <td>
                        ...
                        <div class="user_details">
                            <a href="/my_account"  style="text-decoration: none;" class="profile"><p>Profile</p></a>
                ...
                <tr>
                    ...
                    <tr>
                        <td style="display: flex; align-items: center; justify-content: flex-start; padding: 0px; padding-left: 15px; margin-top:5%">
                           <h6 style="margin-bottom: 2%; margin-left:11%">New Email Address</h6>
                           <input type="email"  style="margin-bottom: 1.5%; margin-left:2%">
                        </td>
                    </tr>
                    <tr>
                        <td class="d-flex justify-content-between" style="padding: 0px; padding-left: 15px;; margin-top:2.5%">
                            <a href="/my_account" style="margin-left: 29%;"><button>Save</button></a>
                        </td>
                    </tr>
                    <tr>
                        <td>
