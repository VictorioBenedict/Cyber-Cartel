                ...
                <tr>
                    ...
                    <td>
                        ...
                        <div class="user_details">
                            ...
                            <a href="/change_passwordV" style="text-decoration: none;" class="change_pass"><p>Change Password</p></a>
                        </div>
                    </td>
                </tr>
                <tr>
            ...
            <table class="table_2">
                <tr>
                    <td style="text-align: right; display: flex; flex-direction: column; align-items: flex-end;">
                        ...
                        <p  style="margin: 0; margin-right: auto; padding-left:10px">For your account's security, do not share your password with anyone else</p>
                        <br>
                    ...
                    <tr>
                        <td style="display: flex; align-items: center; justify-content: flex-start; padding: 0px; padding-left: 15px; margin-top:5%">
                           <h6 style="margin-bottom: 2%; margin-left:11%">New Password</h6>
                           <input type="password"  style="margin-bottom: 1.5%; margin-left:2%">
                        </td>
                    </tr>
                    <tr>
                        <td style="display: flex; align-items: center; justify-content: flex-start; padding: 0px; padding-left: 15px; margin-top:2.5%">
                           <h6 style="margin-bottom: 2%; margin-left:8%">Confirm Password</h6>
                           <input type="password"  style="margin-bottom: 1.5%; margin-left:2%">
                        </td>
                    </tr>
                    <tr>
                        <td class="d-flex justify-content-between" style="padding: 0px; padding-left: 15px;; margin-top:2.5%">
                            <a href="/my_account" style="margin-left: 25.5%;"><button>Save</button></a>
                        </td>
                    </tr>
                    <tr>
                        <td>
