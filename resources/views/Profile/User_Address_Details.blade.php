                ...
                <tr>
                    <td>
                        <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 2%;">
                            ...
                            <button style="margin: 0;"><a href="/add_new_address"  style="text-decoration: none; color: #000000;">+ Add New Address</a></button>
                        </div>
                    ...
                    <tr>
                        <td style="display: flex; align-items: center; justify-content: flex-start; padding: 0px; padding-left: 15px;">
