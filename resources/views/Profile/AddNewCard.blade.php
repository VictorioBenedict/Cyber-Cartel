            ...
            <div class="row justify-content-center">
                <div class="col-lg-8 col-md-8 col-sm-10">
                    <form id="signupForm" style="border: 1px solid #ccc; border-radius: 10px; padding: 20px;">
                        ...
                        <div class="form-group" style="margin-bottom: 5%;">
                            <input type="text" class="form-control" id="expiryDate" name="expiryDate" placeholder="Expiry Date (MM/YY)" pattern="\d{2}/\d{2}" oninput="formatExpiryDate(this)">
                        </div>
                        <div class="form-group" style="margin-bottom: 5%;">
                            <input type="text" class="form-control" id="confirmPassword" name="confirmPassword" placeholder="Name on Card">
                        </div>
                        <div class="d-flex justify-content-between">
                            <button type="submit" class="btn btn-light" style="width: 48%; border: 1px solid #000000;">
                                <a href="/bank_and_card" style="text-decoration: none; color: #000000; width: 100%; display: block;">Cancel</a>
                            </button>

                            <button type="submit" class="btn btn-secondary primary black-button" style="width: 48%;">
                                <a href="/bank_and_card" style="text-decoration: none; color: #ccc; width: 100%; display: block;">Submit</a>
                            </button>
