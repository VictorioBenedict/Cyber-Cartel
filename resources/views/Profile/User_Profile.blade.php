                    ...
                    <td style="text-align: right; display: flex; flex-direction: column; align-items: flex-end;">
                        ...
                        <tr class="email">
                            <td style="display: flex; align-items: center; justify-content: flex-start;">
                                ...
                                <a href="/change_email" style="margin-left: 2%;"><p>change</p></a>
                            </td>
                        </tr>
                        <tr class="phoneN">
                            <td style="display: flex; align-items: center; justify-content: flex-start;">
                                ...
                                <a href="/change_number" style="margin-left: 2%;"><p>change</p></a>
                            </td>
                        </tr>
                        <tr class="gender">
                            <td style="display: flex; align-items: center; justify-content: flex-start;">
                                <p style="margin-left: 10%;">Gender:</p>
                                <p style="margin-left: 2%;">Male</p><input type="radio"  style="margin-left: 2%; margin-bottom:1.5%;">
                                <p style="margin-left: 2%;">Female</p><input type="radio" style="margin-left: 2%; margin-bottom:1.5%;">
                                <p style="margin-left: 2%;">Other</p><input type="radio" style="margin-left: 2%; margin-bottom:1.5%;">
                            </td>
                        </tr>
                        <tr class="bday">
                            <td style="display: flex; align-items: center; justify-content: flex-start;">
