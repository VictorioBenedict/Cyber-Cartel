        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-6 col-md-8 col-sm-10">
                    <form id="loginForm" action="/login" method="post" style="border: 1px solid #ccc; border-radius: 10px; padding: 20px;">
                        @csrf
                        <div class="form-group" style="margin-bottom: 15px;">
                            <label for="username">Code</label>
                            <input type="password" class="form-control" id="username" name="newPass" placeholder="Enter the Code">
                        </div>
                        <a href="#"><p>Resend Code</p></a>
