    ...
    <section style=" margin-bottom: 20px;">
        <div class="container">
            <div class="row justify-content-center">
                ...
                <h5 style="margin-top:2.5%; margin-bottom:2.5% "><b>Update product</b></h5>
                        @if (session('status'))
                ...
                <form action="{{url ('productmanagements/'.$crud->id.'/edit')}}" method = "POST"  enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                <label>details</label>
                                <textarea type="text" name="details"  class="form-control" value="{{$crud -> details}}">{{$crud -> details}}</textarea>
